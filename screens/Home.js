...
const Home = () => {
    ...
    function renderHeader() {
        return (
            <View style={{
                flexDirection: "row", marginVertical: SIZES.padding * 2
            }}>
                <View style={{ flex: 1 }}>
    ...
    function renderFeatures(){
        ...
        const renderItem = ({item}) => (
             <TouchableOpacity
             style={{
                 marginBottom:SIZES.padding*2,width:60,alignItems:'center'
             }}
             ...
             >
                ...
                <Text style={{flexWrap:'wrap',textAlign:'center',...FONTS.body4}}>{item.description}</Text>
             </TouchableOpacity>
        )
